...
public abstract class LunaLearnWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static LunaLearnWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(LunaLearnWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<LunaLearnDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<LunaLearnDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<LunaLearnDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<LunaLearnDbContext, Task<T>> func)
    {
        T result;
