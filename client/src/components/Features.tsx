const Features = () => {
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case "brain":
        return (
          <svg className="w-10 h-10 text-purple" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "chart":
        return (
          <svg className="w-10 h-10 text-green" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "graduation":
        return (
          <svg className="w-10 h-10 text-yellow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "users":
        return (
          <svg className="w-10 h-10 text-pink" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-gray-50 rounded-3xl p-8 text-center transition-all hover:shadow-xl hover:-translate-y-2 duration-300">
              <div className={`w-20 h-20 bg-${feature.icon === 'gamepad' ? 'primary-light' : feature.icon === 'award' ? 'blue-100' : feature.icon === 'brain' ? 'purple-100' : feature.icon === 'chart' ? 'green-100' : feature.icon === 'graduation' ? 'yellow-100' : 'pink-100'} rounded-full flex items-center justify-center mx-auto mb-6`}>
                {getIcon(feature.icon)}
              </div>
              <h3 className="font-fredoka text-2xl mb-4">{feature.title}</h3>
