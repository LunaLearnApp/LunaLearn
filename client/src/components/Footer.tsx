        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-fredoka text-2xl text-white">LearnWithAI</span>
            </div>
            <p className="text-gray-300 mb-6">Making education engaging and fun with AI-powered learning games for kids in grades K-6.</p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-primary-dark rounded-full flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            <h3 className="font-fredoka text-xl mb-6">Support</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="font-fredoka text-xl mb-6">Subscribe</h3>
            <p className="text-gray-300 mb-4">Get weekly updates on new games and features</p>
            <form className="mb-4">
              <div className="flex">
            ...
            <p className="text-gray-400 text-sm">By subscribing, you agree to our Terms and Privacy Policy</p>
          </div>
        </div>
