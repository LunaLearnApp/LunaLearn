  ...
  return (
    <>
      ...
      <div className="pt-24 pb-16 bg-gradient-to-br from-pink-50 via-blue-50 to-purple-50 relative">
        ...
        <div className="absolute top-[-160px] right-[-100px] w-[300px] h-[300px] bg-purple-400 opacity-60 rounded-full zindex-100"></div>
            ...
            <>
              ...
              <Tabs defaultValue="dashboard" className="mb-12">
                ...
                <TabsContent value="characters" className="focus:outline-none">
                  <div className="mb-8">
                    <h3 className="text-2xl text-primary font-fredoka mb-4">Your Learning Companions</h3>
                    <p className="text-gray-600 mb-6">
