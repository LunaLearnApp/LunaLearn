...
const DashboardPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>My Dashboard | LearnWithAI</title>
        <meta 
          name="description" 
            ...
            <div>
              ...
              {!isLoading && (
                <div className="flex items-center gap-2">
                  <div className="px-3 py-1 bg-yellow rounded-full text-dark font-bold text-sm">
                  ...
                  <div className="px-3 py-1 bg-purple/10 rounded-full text-purple font-bold text-sm flex items-center">
            ...
            <>
                ...
                <Card>
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-fredoka">{unlockedBadges.length}</h3>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-fredoka">24</h3>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-fredoka">4.5 hours</h3>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-fredoka">3</h3>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Tabs defaultValue="dashboard" className="mb-12">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="p-4 bg-gradient-to-r from-yellow/20 to-primary/20 rounded-lg mb-4">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          ...
                          {unlockedBadges.length > 0 ? (
                            <Button variant="ghost" className="w-full mt-4 justify-center gap-1" asChild>
                              <Link href="/achievements">
                                <a>View All Badges <ChevronRight size={16} /></a>
                              </Link>
                            </Button>
                          ) : (
                ...
                <TabsContent value="achievements" className="focus:outline-none">
                  <div className="mb-8">
                    <h3 className="text-2xl font-fredoka mb-4">Your Achievements</h3>
                    <p className="text-gray-600 mb-6">
                      Collect badges by completing activities and mastering skills!
                    </p>
                    
                    <div className="bg-white rounded-lg shadow p-6 mb-8">
                      <h4 className="font-bold mb-2">Achievement Progress</h4>
                          ...
                          <div className="mb-3 relative">
                            ...
                            {badge.unlocked ? (
                              <div className="absolute -bottom-2 -right-2 bg-white rounded-full p-1 shadow-md">
                                <div className="bg-yellow text-dark w-6 h-6 rounded-full flex items-center justify-center font-fredoka text-sm">
                                  {badge.level}
                                </div>
                              </div>
                            ) : (
                  ...
                  <Button asChild className="bg-primary text-white font-bold px-6 py-2 rounded-full shadow hover:shadow-lg transition-all hover:-translate-y-1 duration-300">
                    <Link href="/achievements">
                      <a>View Full Achievements</a>
                    </Link>
                  </Button>
                </TabsContent>
                
                <TabsContent value="characters" className="focus:outline-none">
                  <div className="mb-8">
                    <h3 className="text-2xl font-fredoka mb-4">Your Learning Companions</h3>
                    <p className="text-gray-600 mb-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8">
                      {characters?.map((character) => (
                        <div key={character.id} className="flex flex-col items-center">
                          <div 
                            className={`w-24 h-24 mb-4 rounded-full p-2 ${character.color} hover:scale-110 transition-transform cursor-pointer`}
                          >
                  ...
                  <Button asChild className="bg-purple text-white font-bold px-6 py-2 rounded-full shadow hover:shadow-lg transition-all hover:-translate-y-1 duration-300">
                    <Link href="/characters">
                      <a>Meet All Characters</a>
                    </Link>
                  </Button>
                </TabsContent>
              </Tabs>
