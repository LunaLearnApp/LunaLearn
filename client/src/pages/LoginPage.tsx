  ...
  return (
    <section className="py-16 bg-white overflow-hidden relative ">
      <div className="flex items-center justify-center container p-10 mx-auto px-4">
        ...
        <div className="flex items-center justify-center overflow-hidden w-[40vw] h-[110vh] bg-gradient-to-r from-pink-200 to-blue-200 rounded-3xl p-2 md:p-2">
          
          <div className="max-w-3xl mx-auto">
            <h2 className="font-fredoka text-6xl mb-6 text-primary text-center">Log in</h2>
           
            <div className="bg-white/90 w-[30vw] h-[90vh] rounded-2xl p-6 mb-8">
