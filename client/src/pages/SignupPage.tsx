  ...
  return (
    <section className="py-16 bg-white">
      <div className="flex items-center justify-center container p-10 mx-auto px-4">
        ...
        <div className="flex items-center justify-center bg-gradient-to-r from-pink-200 to-blue-200 rounded-3xl p-8 md:p-12">
          
          <div className="max-w-3xl mx-auto">
            <h2 className="font-fredoka text-6xl mb-6 text-primary text-center">Sign Up</h2>
            
            <div className="bg-white/90 w-[30vw] h-[64vh] rounded-2xl p-6 mb-8">
              ...
              <form className="space-y-4 p-2" method="POST" action="/login">
                ...
                <div className="flex justify-center items-center w-full px-4 md:px-0">
                  <button type="submit" className="w-[90%] bg-primary text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200">
                    <span className="ml-2">Sign Up</span>
                  </button>
        
                  <hr/>

                  <button type="submit" className="w-[90%] bg-white text-gray-700 font-semibold py-2 px-4 rounded-md hover:bg-gray-100 transition duration-200 flex items-center justify-center border"> <FcGoogle className="w-6 h-6" /><span className="ml-2">Sign Up with Google</span>
                  </button>                    

                  <button type="submit" className="w-[90%] bg-black text-white font-semibold py-2 px-4 rounded-md hover:bg-gray-800 transition duration-200 flex items-center justify-center"><FaApple className="w-6 h-6" /><span className="ml-2">Sign Up with Apple</span>
                  </button>
                </div>
